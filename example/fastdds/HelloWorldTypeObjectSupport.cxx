        ...
        TypeIdentifierPair& type_ids_HelloWorld)
{
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_HelloWorld)
    {
        ...
        CompleteStructMemberSeq member_seq_HelloWorld;
        {
            ...
            AppliedAnnotationSeq tmp_ann_custom_index;
            eprosima::fastcdr::optional<std::string> unit_index;
            eprosima::fastcdr::optional<AnnotationParameterValue> min_index;
            eprosima::fastcdr::optional<AnnotationParameterValue> max_index;
            eprosima::fastcdr::optional<std::string> hash_id_index;
            if (unit_index.has_value() || min_index.has_value() || max_index.has_value() || hash_id_index.has_value())
            {
                member_ann_builtin_index = TypeObjectUtils::build_applied_builtin_member_annotations(unit_index, min_index, max_index, hash_id_index);
            }
            if (!tmp_ann_custom_index.empty())
            {
                ann_custom_HelloWorld = tmp_ann_custom_index;
            }
